...
},{"./init.js":2,"./lib/parseData.js":5,"./vender/ajax.js":6,"./vender/underscore.js":9}],2:[function(require,module,exports){
/*
* @Author: wanghongxin
* @Date:   2015-05-08 23:57:28
* @Last Modified by:   wanghongxin
...
},{"./lib/cut.js":3,"./lib/lottery.js":4}],3:[function(require,module,exports){
(function(root,factory) {
    ...
    function Cut(height) {
        var car = {
            ...
            toSlide    : function(index, oldPage) {//跳页面
                var pages                        = car._page;
            ...
            // decideNow:function(now){
            //     this._pageNow=now;
            //     this._page.removeClass('z-animate action');
            //     this._page.eq(now).addClass('z-animate');
            ...
            //     }
            //     var self=this;
            //     var now=this._pageNow,
            //         height=$('.p-ct').height(),
            //         total=this._pageNum,
            //         next=now===0?(total-1):this._pageNow-1,
            //         page=this._page,
            //         target=page.eq(next);
            //     target.
            //         removeClass('f-hide').addClass('show').
            //         css({
            //             'transform':'translate3d(0,-'+height+'px,0)',
            //             'webkitTransform':'translate3d(0,-'+height+'px,0)',
            //             '-webkit-transform':'translate3d(0,-'+height+'px,0)',
            //         });
            //     car.lazy_change(car2._page.eq(next), false);
            //     _.delay(function(){
            //         target.
            //             css({
            ...
            //             });
            //         _.delay(function(){
            //             page.eq(now).addClass('f-hide');
            //             target.removeClass('show');
            //             self.decideNow(next);
            //         }, 300);
            //     },100);
            //     $(window).trigger('cut',[next,now,this._page]);
            // },
            // slideDown:function(){
            ...
            //         height=$('.p-ct').height(),
            //         total=this._pageNum,
            //         next=(now===total-1)?0:this._pageNow+1,
            //         page=this._page,
            //         target=page.eq(next);
            //     target.
            //         removeClass('f-hide').addClass('show').
            ...
            //     $(window).trigger('cut',[next,now,this._page]);
            // },
            _setHeight:function(height){//iframe适配
                $('.p-ct').height(height);
            ...
            _setHeight2:function(height){//手机端固定640*960
                $('.p-ct').height(height);
                $('.m-page').height(960);
                $('.page-con').height(960);
                $('.translate-back').height(960);
                cut._height=height;
                var top=(height-960)/2;
                var ratio=top>0?height/960:1;
                $('.translate-back').css({
                    'top':top+'px',
            ...
            decideNow:function(now){//决定下一个是哪一个页面
                this._pageNow=now;
                this._page.removeClass('z-animate action');
                this._page.eq(now).addClass('z-animate');

            },
            slideUp:function(){//往上翻页
                ...
                var now=this._pageNow,
                    ...
                    page=this._page,
                    target=page.eq(next);
                car.lazy_change(car._page.eq(next), false);
                target.
                    removeClass('f-hide').addClass('show').
                    css({
                        'transform':'translate3d(0,-'+height+'px,0)',
            ...
            slideDown:function(){//往下翻页
                ...
                var now=this._pageNow,
                    ...
                    page=this._page,
                    target=page.eq(next);
                car.lazy_change(car._page.eq(next), false);//懒加载下一页
                target.
                    removeClass('f-hide').addClass('show').
                    css({
                        'transform':'translate3d(0,'+height+'px,0)',
                ...
                $(window).trigger('cut',[next,now,this._page]);//触发成功的回调函数
            },
            // 微信初始化函数
            ...
            haddle_envent_fn: function() {
                ...
                car._on('success', function() {
                    ...
                    $(window).trigger('cut',[now,pre,this._page]);
                            ...
                            .on('load', function() {
                                if (self.is('img')) {
                                    ...
                                    if(!self.hasClass('f-shape')){
                                        ...
                                        self.css({
                                            'webkitMask': 'url(' + srcImg + ') 0px 0px round',
                                            '-webkit-mask': 'url(' + srcImg + ') 0px 0px round',
                                            'mask': 'url(' + srcImg + ') 0px 0px round',
...
},{"../vender/event.js":7,"../vender/query.js":8}],4:[function(require,module,exports){
/* 
* @Author: wanghongxin
* @Date:   2015-05-08 23:57:28
* @Last Modified by:   wanghongxin
* @Last Modified time: 2015-06-08 16:43:01
*/
        ...
        init: function(lottery, lotteryType) {
            ...
            if (this.vail) {
                this.background = this.background || this.createElement('canvas', {
                    style: 'position:absolute;left:50%;top:0;width:640px;margin-left:-320px;height:100%;background-color:transparent;'
                });
            }

            // 生成蒙板DOM
            this.mask = this.mask || this.createElement('canvas', {
                style: 'background-color:transparent;position:absolute;top:0;z-index:222222;'
            });
